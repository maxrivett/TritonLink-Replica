                    ...
                    try {
                        ...
                        if ("update".equals(action)) {
                            PreparedStatement pstmt = conn.prepareStatement(
                                "UPDATE course_waitlist SET NUMUNITS = ? WHERE STUDENTID = ? AND COURSEID = ? AND QUARTER = ? AND YEAR = ? AND SECTIONID = ?");
                            ...
                            PreparedStatement pstmt = conn.prepareStatement(
                                "INSERT INTO course_waitlist (STUDENTID, COURSEID, QUARTER, YEAR, SECTIONID, NUMUNITS) VALUES (?, ?, ?, ?, ?, ?)");
                            pstmt.setInt(1, Integer.parseInt(request.getParameter("STUDENTID")));
                            pstmt.setInt(2, Integer.parseInt(request.getParameter("COURSEID")));
                            pstmt.setString(3, request.getParameter("QUARTER"));
                            pstmt.setInt(4, Integer.parseInt(request.getParameter("YEAR")));
