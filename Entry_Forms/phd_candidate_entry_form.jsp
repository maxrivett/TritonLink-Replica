            ...
            <td>
                ...
                <%
                    ...
                    if (action != null && action.equals("insert")) {
                        ...
                        pstmt4.setInt(1, Integer.parseInt(request.getParameter("STUDENTID")));
                ...
                <%
                    ...
                    ResultSet rs = statement.executeQuery
                        ("SELECT * FROM student, graduate, candidates WHERE " + 
                        "candidates.STUDENTID = graduate.STUDENTID and graduate.STUDENTID = student.STUDENTID");
                %>
                <table>
                    <tr>
                        <th>Student_ID</th>
